...
class Ui_MainWindow(QtWidgets.QMainWindow):
    ...
    def start_syn(self):
        self.wifil4 = self.choose_eth_2.currentText()
        self.dst_ipl4 = self.textEdit_10.toPlainText()
        self.dst_macl4 = self.textEdit_11.toPlainText()
        self.netl4 = self.textEdit_9.toPlainText()
        self.portl4 = int(self.textEdit_26.toPlainText())
    ...
    def send_syn(self):
        ...
        while self.flag5:
            ...
            if times % 10 == 0:
                self.textEdit_29.append(packet.summary())
            times = times + 1
    ...
    def send_arp(self):
        ...
        while self.flag6:
            ...
            sendp(packet*10, iface=self.wifil4)
            if times % 10 == 0:
                self.textEdit_12.append(packet.summary())
            times = times + 1